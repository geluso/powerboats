...
var StraightUnlessDamage = function () {
  function StraightUnlessDamage(game) {
    _classCallCheck(this, StraightUnlessDamage);

    this.game = game;
    this.cycle = 0;
  }

  _createClass(StraightUnlessDamage, [{
    key: "consider",
    value: function consider() {
      this.cycle++;
      if (this.cycle > 1) {
        return true;
      }
  ...
  return StraightUnlessDamage;
}();

;

var SpeedUpUntilDamage = function () {
  function SpeedUpUntilDamage(game) {
    _classCallCheck(this, SpeedUpUntilDamage);
  ...
  _createClass(SpeedUpUntilDamage, [{
    key: "consider",
    value: function consider() {
      this.cycle++;
  ...
  return SpeedUpUntilDamage;
}();

var FaceBuoy = function () {
  function FaceBuoy(game) {
    _classCallCheck(this, FaceBuoy);

    this.game = game;
    this.cycle = 0;
  }

  _createClass(FaceBuoy, [{
    key: "consider",
    value: function consider() {
      this.cycle++;
...
var UseRoutePlanner = function () {
  function UseRoutePlanner(game) {
    _classCallCheck(this, UseRoutePlanner);

    this.game = game;
    this.cycle = 0;
  }

  _createClass(UseRoutePlanner, [{
    key: "consider",
    value: function consider() {
      this.cycle++;
  ...
  return UseRoutePlanner;
}();

var ComposedStrategy = function () {
  function ComposedStrategy(game, considerations) {
    _classCallCheck(this, ComposedStrategy);
...
var GoStraightUntilDamage = function () {
  function GoStraightUntilDamage(game) {
    _classCallCheck(this, GoStraightUntilDamage);

    var considerations = [StraightUnlessDamage];

    this.runner = new ComposedStrategy(game, considerations);
  }

  _createClass(GoStraightUntilDamage, [{
    key: "churn",
    value: function churn() {
  ...
  return GoStraightUntilDamage;
}();

var SpeedUpStraightUntilDamage = function () {
  function SpeedUpStraightUntilDamage(game) {
    _classCallCheck(this, SpeedUpStraightUntilDamage);

    var considerations = [SpeedUpUntilDamage, StraightUnlessDamage];

    this.runner = new ComposedStrategy(game, considerations);
  }

  _createClass(SpeedUpStraightUntilDamage, [{
    key: "churn",
    value: function churn() {
      return this.runner.churn();
    }
  ...
  return SpeedUpStraightUntilDamage;
}();

var TurnTowardBuoySlow = function () {
  function TurnTowardBuoySlow(game) {
    _classCallCheck(this, TurnTowardBuoySlow);

    var considerations = [FaceBuoy];

    this.runner = new ComposedStrategy(game, considerations);
  }

  _createClass(TurnTowardBuoySlow, [{
    key: "churn",
    value: function churn() {
      return this.runner.churn();
    }
  ...
  return TurnTowardBuoySlow;
}();

var TurnTowardBuoyFast = function () {
  function TurnTowardBuoyFast(game) {
    _classCallCheck(this, TurnTowardBuoyFast);

    var considerations = [FaceBuoy, SpeedUpUntilDamage];

    this.runner = new ComposedStrategy(game, considerations);
  }

  _createClass(TurnTowardBuoyFast, [{
    key: "churn",
    value: function churn() {
      return this.runner.churn();
    }
  ...
  return TurnTowardBuoyFast;
}();

var RoutePlanningStrategy = function () {
  function RoutePlanningStrategy(game) {
    _classCallCheck(this, RoutePlanningStrategy);

    var considerations = [UseRoutePlanner];

    this.runner = new ComposedStrategy(game, considerations);
  }

  _createClass(RoutePlanningStrategy, [{
    key: "churn",
    value: function churn() {
      return this.runner.churn();
    }
  ...
  return RoutePlanningStrategy;
}();

var AIStrategies = {
  StraightUnlessDamage: StraightUnlessDamage,
  SpeedUpUntilDamage: SpeedUpUntilDamage,
  FaceBuoy: FaceBuoy,
  UseRoutePlanner: UseRoutePlanner,
  ComposedStrategy: ComposedStrategy,
  GoStraightUntilDamage: GoStraightUntilDamage,
  SpeedUpStraightUntilDamage: SpeedUpStraightUntilDamage,
  TurnTowardBuoySlow: TurnTowardBuoySlow,
  TurnTowardBuoyFast: TurnTowardBuoyFast,
  RoutePlanningStrategy: RoutePlanningStrategy
};
...
var CONFIG = {
  ...
  USE_BUOY_ARRAY: true,
  BUOYS: ["39,-28,-11", "44,-43,-1", "16,-20,4"],
  AI_TURN_DELAY: 1000,
...
var Resources = {
  WATER: WATER, LAND: LAND, START_RED: START_RED, START_BLACK: START_BLACK, START_WHITE: START_WHITE, HOVERED: HOVERED
};

var ALL_RESOURCES = [WATER, LAND, START_RED, START_BLACK, START_WHITE, HOVERED];
...
var Tile = function () {
  function Tile(row, col, xIndex, yIndex, zIndex, resource) {
  ...
  _createClass(Tile, [{
    ...
    key: "keyObjectToKey",
    value: function keyObjectToKey(keyObject) {
    ...
    key: "isNavigable",
    value: function isNavigable(course) {
    ...
    value: function fromJSON(json) {
      ...
      var resource = Resources.resourceFromString(json.resourceName);
    ...
    key: "createWaterTile",
    value: function createWaterTile(row, col, xIndex, yIndex, zIndex) {
    ...
    key: "createLandTile",
    value: function createLandTile(row, col, xIndex, yIndex, zIndex) {
...
var RandomTileCreator = function () {
  // default: 1 tile of land for every 40 tiles of water
  function RandomTileCreator() {
    var landToWaterRatio = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1 / 40;

    _classCallCheck(this, RandomTileCreator);

    this.ratio = landToWaterRatio;
  }

  _createClass(RandomTileCreator, [{
    key: "create",
    value: function create(row, col, xx, yy, zz) {
...
var JSONTileCreator = function () {
  function JSONTileCreator(landTilesJSON) {
    var _this = this;

    _classCallCheck(this, JSONTileCreator);

    this.landTilesJSON = landTilesJSON;
    this.landTileKeys = new Set();
    landTilesJSON.forEach(function (tile) {
      var key = _this.getKey(tile.row, tile.col);
      _this.landTileKeys.add(key);
    });
  }

  _createClass(JSONTileCreator, [{
    key: 'getKey',
    value: function getKey(row, col) {
      return row + ',' + col;
    }
  }, {
    key: 'create',
    value: function create(row, col, xx, yy, zz) {
      ...
      var tile = new Tile(row, col, xx, yy, zz, resource);
      return tile;
    }
  }]);

  return JSONTileCreator;
}();
...
var Tile = require('../tile');
var Resources = require('../resources');
var RandomTileCreator = require('./tile-creators/random-tile-creator');
var JSONTileCreator = require('./tile-creators/json-tile-creator');

var CENTER;

var TileSpace = function () {
  function TileSpace(rows, cols, tileCreator) {
    _classCallCheck(this, TileSpace);
  ...
  _createClass(TileSpace, [{
    key: 'toJSON',
    value: function toJSON() {
      var json = {
        rows: this.rows,
        cols: this.cols,
        landTiles: this.tiles.filter(function (tile) {
          return tile.resource === Resources.LAND;
        }).map(function (tile) {
          return tile.toJSON();
        })
      };
    ...
    key: 'createHexagons',
    value: function createHexagons(tileCreator) {
      ...
      for (var row = 0; row < maxRows; row++) {
        ...
        for (var col = 0; col < this.cols; col++) {
          ...
          var isTopBorder = row < landBorder - 1;
          var isBottomBorder = row > maxRows - landBorder;
          var isLeftBorder = col < landBorder;
          var isRightBorder = col > this.cols - landBorder;
          var isBorder = isTopBorder || isBottomBorder || isLeftBorder || isRightBorder;
    ...
    key: 'centerOnHexCenter',
    value: function centerOnHexCenter() {
      // this is default layout
    }
  }, {
    key: 'centerOnHexEdges',
    value: function centerOnHexEdges() {
    ...
    key: 'getByKeyRowCol',
    value: function getByKeyRowCol(row, col) {
      var key = row + ',' + col;
      return this.keyedTilesRowCol[key];
    }
  }, {
    key: 'nextTileInDirection',
    value: function nextTileInDirection(tile, direction) {
      if (!tile) {
        return;
      }
    ...
    value: function toString() {
      ...
      for (var irow = 0; irow < this.rows; irow++) {
        ...
        for (var icol = 0; icol < this.cols; icol++) {
          var tile = this.getByKeyRowCol(irow, icol);
          var label = void 0;
    ...
    value: function fromJSON(json) {
      var rows = json.rows,
          cols = json.cols,
          landTiles = json.landTiles;

      var creator = new JSONTileCreator(landTiles);
...
var Buoy = function () {
  ...
  _createClass(Buoy, [{
    ...
    key: "fromJSON",
    value: function fromJSON(json) {
      var turnNumber = json.turnNumber,
          tile = json.tile;

      tile = Tile.fromJSON(tile);
      var buoy = new Buoy(turnNumber, tile);
      return buoy;
    }
  }]);
...
var FinishLineDetector = function () {
  function FinishLineDetector() {
    _classCallCheck(this, FinishLineDetector);

    this.finishLineTiles = [];
    this.pointsActivated = 0;
  }

  _createClass(FinishLineDetector, [{
    key: "add",
    ...
    key: "track",
    value: function track(boat, tile) {
...
var FinishLineDetector = require('./finish-line-detector');

var NUMBER_OF_BUOYS = 3;

var Course = function () {
  function Course(tilespace) {
  ...
  _createClass(Course, [{
    ...
    value: function toJSON() {
      var json = {
        ...
        buoys: this.buoys.map(function (buoy) {
          return buoy.toJSON();
        })
      };
      return json;
    ...
    key: 'setupBuoys',
    value: function setupBuoys() {
      var _this = this;

      var chooseInsideTile = function chooseInsideTile(tiles, minDistance) {
        var maxAttempts = 10;
        var attempts = 0;

        while (attempts < maxAttempts) {
          var _tile = _.sample(tiles);
          var isWithinVertical = _tile.row >= minDistance && _tile.row < _this.tilespace.rows - minDistance;
          var isWithinHorizontal = _tile.col >= minDistance && _tile.col < _this.tilespace.cols - minDistance;
    ...
    key: 'setupStartLine',
    value: function setupStartLine(startPos, startDirection) {
      this.start = startPos;
    ...
    key: 'fromJSON',
    value: function fromJSON(json) {
      var tilespace = TileSpace.fromJSON(json.tilespace);
      var course = new Course(tilespace);

      var start = Tile.fromJSON(json.start);
      start.resource = Resources.START_RED;
      var startDirection = json.startDirection;
      course.setupStartLine(start, startDirection);

      course.buoys = json.buoys.map(function (buoyJSON) {
        return Buoy.fromJSON(buoyJSON);
      });
      course.buoys.forEach(function (buoy) {
        var tile = tilespace.getByKeyRowCol(buoy.tile.row, buoy.tile.col);
        tile.buoy = buoy;
...
var TileGeo = function () {
  function TileGeo() {
    _classCallCheck(this, TileGeo);
  }

  _createClass(TileGeo, null, [{
    key: "distance",
    value: function distance(t1, t2) {
...
var FinishLineDetector = require('./finish-line-detector');
var TileGeo = require('./geo/tile-geo');

var RoutePlanner = function () {
  function RoutePlanner(boat) {
  ...
  _createClass(RoutePlanner, [{
    ...
    key: 'deepExplore',
    value: function deepExplore(boat, depth, options) {
    ...
    key: 'performActions',
    value: function performActions(boat, actions) {
    ...
    key: 'findBestScore',
    value: function findBestScore(options) {
...
Directions.possibleDirections = ["north", "north-east", "south-east", "south", "south-west", "north-west"];
...
var Directions = require('./geo/directions');

var BuoyTracker = function () {
  function BuoyTracker(buoy) {
    _classCallCheck(this, BuoyTracker);
  ...
  _createClass(BuoyTracker, [{
    ...
    key: "initDirections",
    value: function initDirections(tilespace) {
    ...
    key: "track",
    value: function track(tilespace, boat, tile) {
      if (!this.north) {
    ...
    key: "registerDirection",
    value: function registerDirection(direction, boat) {
    ...
    key: "registerAllDirections",
    value: function registerAllDirections(bool) {
    ...
    key: "getDirectionStatus",
    value: function getDirectionStatus(direction, boatColor) {
    ...
    key: "fromJSON",
    value: function fromJSON(game, json) {
      var buoyIndex = json.buoy.turnNumber - 1;
      var buoy = game.course.buoys[buoyIndex];

      var tracker = new BuoyTracker(buoy);
...
var RoutePlanner = require('./route-planner');
var BuoyTracker = require('./buoy-tracker');
var Resources = require('./resources');
var TileGeo = require('./geo/tile-geo');

var Boat = function () {
  function Boat(game, color, tile, type, direction) {
  ...
  _createClass(Boat, [{
    ...
    value: function updateFromJSON(json) {
      ...
      this.dice = json.dice.map(function (dice) {
        return Dice.fromJSON(dice);
      });

      // trackers
      this.trackerIndex = json.trackerIndex;
      this.trackers = json.trackers.map(function (tracker) {
        return BuoyTracker.fromJSON(_this.game, tracker);
      });
    }
  }, {
    key: 'toJSON',
    value: function toJSON() {
      return {
        damage: this.damage,
        dice: this.dice.map(function (dice) {
          return dice.toJSON();
        }),
        color: this.color,
        tile: this.tile,
    ...
    key: 'checkRouteDamage',
    value: function checkRouteDamage() {
    ...
    key: 'followRoute',
    value: function followRoute(isMovingBoatAlongRoute) {
    ...
    key: 'rollInNewDice',
    value: function rollInNewDice() {
      var dice = new Dice();
      this.dice.push(dice);
    }
  }, {
    key: 'removeDice',
    value: function removeDice(index) {
      this.dice.remove(index);
    }
  }, {
    key: 'rerollDice',
    value: function rerollDice(index) {
      this.dice[index].reroll();
    }
  }, {
    key: 'highlightRoute',
    value: function highlightRoute() {
    ...
    key: 'unhighlightRoute',
    value: function unhighlightRoute() {
    ...
    key: 'getCurrentRouteTiles',
    value: function getCurrentRouteTiles() {
      var tiles = [];
    ...
    key: 'straightToDistanceToBuoy',
    value: function straightToDistanceToBuoy() {
      var route = this.getCurrentRouteTiles();
    ...
    key: 'leftTurnDistanceToBuoy',
    value: function leftTurnDistanceToBuoy() {}
  }, {
    key: 'rightTurnDistanceToBuoy',
    value: function rightTurnDistanceToBuoy() {}
    ...
    key: 'faceBuoy',
    value: function faceBuoy(allowedDirections) {
    ...
    key: 'faceBuoyWithOneTurn',
    value: function faceBuoyWithOneTurn() {
      var clockwise = Directions.clockwiseNext[this.direction];
      var counterClockwise = Directions.counterClockwiseNext[this.direction];
      var allowedDirections = [clockwise, this.direction, counterClockwise];
    ...
    value: function fromJSON(game, json) {
      ...
      var boat = new Boat(game, color, tile, type);
...
var BoatClone = function (_Boat) {
  _inherits(BoatClone, _Boat);

  function BoatClone(source) {
    _classCallCheck(this, BoatClone);

    var _this2 = _possibleConstructorReturn(this, (BoatClone.__proto__ || Object.getPrototypeOf(BoatClone)).call(this, source.game, source.color, source.tile, source.type));
  ...
  _createClass(BoatClone, [{
    key: 'getFirstClone',
    value: function getFirstClone() {
    ...
    value: function speedUp() {
      ...
      _get(BoatClone.prototype.__proto__ || Object.getPrototypeOf(BoatClone.prototype), 'speedUp', this).call(this);
    }
  }, {
    key: 'slowDown',
    value: function slowDown() {
      this.actions.push("slower");
      _get(BoatClone.prototype.__proto__ || Object.getPrototypeOf(BoatClone.prototype), 'slowDown', this).call(this);
    }
  }, {
    key: 'turnLeft',
    value: function turnLeft() {
      this.actions.push("left");
      _get(BoatClone.prototype.__proto__ || Object.getPrototypeOf(BoatClone.prototype), 'turnLeft', this).call(this);
    }
  }, {
    key: 'turnRight',
    value: function turnRight() {
      this.actions.push("right");
      _get(BoatClone.prototype.__proto__ || Object.getPrototypeOf(BoatClone.prototype), 'turnRight', this).call(this);
    }
  }, {
    key: 'goStraight',
    value: function goStraight() {
      this.actions.push("go");
      _get(BoatClone.prototype.__proto__ || Object.getPrototypeOf(BoatClone.prototype), 'goStraight', this).call(this);
    }
  }]);
...
var AITurn = function () {
  function AITurn(screen, game, strategyClass) {
    _classCallCheck(this, AITurn);
  ...
  _createClass(AITurn, [{
    key: "initiateTurnStart",
    value: function initiateTurnStart() {
      this.waitDelay();
    }
  }, {
    key: "waitDelay",
    value: function waitDelay() {
      var that = this;
      setTimeout(function () {
    ...
    key: "considerOptions",
    value: function considerOptions() {
...
var AITurn = require('./ai/ai-turn');

var Game = function () {
  function Game(course) {
  ...
  _createClass(Game, [{
    ...
    value: function setCurrentPlayer(color) {
      var _this = this;
      ...
      this.boats.forEach(function (boat, index) {
        if (boat.color === color) {
          _this.currentPlayerIndex = index;
          _this.getCurrentPlayer().highlightRoute();
        }
      });
    }
  }, {
    key: 'addBoat',
    value: function addBoat(boat) {}
  }, {
    key: 'placeBoatsOnStartLine',
    value: function placeBoatsOnStartLine() {
    ...
    value: function toJSON() {
      return {
        ...
        boats: this.boats.map(function (boat) {
          return boat.toJSON();
        })
    ...
    value: function endTurn() {
      ...
      setTimeout(function () {
        _this2.delayedEndTurn();
      }, Config.AI_TURN_DELAY);
    }
  }, {
    key: 'delayedEndTurn',
    value: function delayedEndTurn(screen) {
    ...
    key: 'replaceCurrentBoat',
    value: function replaceCurrentBoat(newBoat) {
    ...
    key: 'fromJSON',
    value: function fromJSON(json) {
      var course = Course.fromJSON(json.course);
      var game = new Game(course);

      json.boats.forEach(function (boat) {
...
var BuoyDrawer = function () {
  function BuoyDrawer(ctx) {
    _classCallCheck(this, BuoyDrawer);

    this.ctx = ctx;
  }

  _createClass(BuoyDrawer, [{
    key: "draw",
    value: function draw(buoy, x, y) {
...
var Point = require('../geo/point');

var BuoyTrackerDrawer = function () {
  function BuoyTrackerDrawer() {
    _classCallCheck(this, BuoyTrackerDrawer);
  }

  _createClass(BuoyTrackerDrawer, null, [{
    key: "draw",
    value: function draw(tracker, ctx, tilespace, boatColor) {
      if (!tracker.north) {
...
var Tile = require('../tile');
var TileDrawer = require('./tile-drawer');
var BoatDrawer = require('./boat-drawer');

var Point = require('../geo/point');
var Hexagon = require('../geo/hexagon');

var GameDrawer = function () {
  function GameDrawer(ctx, game) {
  ...
  _createClass(GameDrawer, [{
    ...
    value: function measure() {
      var TILE_HEIGHT = this.ctx.height / this.tilespace.rows / 4;
      var HALF_EDGE = TILE_HEIGHT / (Math.sqrt(3) / 2);
      var EDGE_LENGTH = HALF_EDGE * 2;
      var TILE_SIZE = EDGE_LENGTH;
      ...
      for (var row = 0; row <= this.tilespace.rows; row++) {
        for (var col = 0; col < this.tilespace.cols; col++) {
          ...
          var tile = this.tilespace.getByKeyRowCol(row, col);
          if (tile) {
            tile.x = x;
            tile.y = y;

            var hexagon = new Hexagon(x, y, TILE_SIZE);
            tile.shape = hexagon;
          }
        }
      }
...
var GameDrawer = require('./drawers/game-drawer');
...
var Screen = function () {
  ...
  _createClass(Screen, [{
    ...
    key: "destoryHandlers",
    value: function destoryHandlers() {
...
var PlayerSelection = function () {
  ...
  _createClass(PlayerSelection, null, [{
    key: 'init',
    value: function init(game, screen) {
      var players = document.getElementById('players');
      var playerSelects = [].concat(_toConsumableArray(players.getElementsByClassName('player')));

      var currentPlayerSelect = void 0;
      playerSelects.forEach(function (playerSelect) {
        ...
        playerSelect.addEventListener('click', function () {
          var color = playerSelect.getAttribute('data-player');
...
RemoteControls.initializeControls = function (screen, game) {
  ...
  function buildParams(action) {
    ...
    console.log('action');
    var gameParams = {
      color: color, action: action, direction: direction
    };
...
var RandomTileCreator = require('./geo/tile-creators/random-tile-creator');
var JSONTileCreator = require('./geo/tile-creators/json-tile-creator');

var Boat = require('./boat');

var PlayerSelection = require('./player/player-selection');
var LocalControls = require('./player/local-controls');
var RemoteControls = require('./player/remote-controls');
...
function createLocalGame() {
  ...
  var currentTile = course.start;
  for (var i = 0; i < Config.PLAYER_TYPES.length; i++) {
    var color = Config.COLORS[i];
    var playerType = Config.PLAYER_TYPES[i];
    var boat = new Boat(game, color, currentTile, playerType);
    game.boats.push(boat);
    boat.faceBuoy();
